...
interface DeferredManager {
     ...
     * @return Kromise
     */
    fun <D, F> `when`(Kromise: Kromise<D, F>): Kromise<D, F>
     ...
     * @see .when
     */
    fun `when`(runnable: Runnable): Kromise<Void, Throwable>
     ...
     * @see .when
     */
    fun <D> `when`(callable: Callable<D>): Kromise<D, Throwable>
     ...
     * @return [.when]
     */
    fun <D> `when`(future: Future<D>): Kromise<D, Throwable>
     ...
     * @see .when
     */
    fun `when`(runnable: DeferredRunnable): Kromise<Void, Throwable>
     ...
     */
    fun <D> `when`(
            callable: DeferredCallable<D>): Kromise<D, Throwable>
     ...
     */
    fun <D> `when`(task: DeferredFutureTask<D>): Kromise<D, Throwable>
    ...
    fun <F, V1, V2> `when`(
            ...
            KromiseV2: Kromise<V2, *>): Kromise<MultipleResults2<V1, V2>, OneReject<F>>
    ...
    fun <F, V1, V2, V3> `when`(
            ...
            KromiseV3: Kromise<V3, *>): Kromise<MultipleResults3<V1, V2, V3>, OneReject<F>>
    ...
    fun <F, V1, V2, V3, V4> `when`(
            ...
            KromiseV4: Kromise<V4, *>): Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<F>>
    ...
    fun <F, V1, V2, V3, V4, V5> `when`(
            ...
            KromiseV5: Kromise<V5, *>): Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<F>>
    ...
    fun <F, V1, V2, V3, V4, V5> `when`(
            ...
            Kromise6: Kromise<*, *>,
            vararg Kromises: Kromise<*, *>): Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<F>>
     ...
     */
    fun `when`(
            runnable1: Runnable, runnable2: Runnable, vararg runnables: Runnable): Kromise<MultipleResults, OneReject<Throwable>>
    ...
    fun <V1, V2, V3> `when`(
            ...
            callableV3: Callable<V3>): Kromise<MultipleResults3<V1, V2, V3>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4> `when`(
            ...
            callableV4: Callable<V4>): Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4, V5> `when`(
            ...
            callableV5: Callable<V5>): Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4, V5> `when`(
            ...
            callable6: Callable<*>,
            vararg callables: Callable<*>): Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    ...
    fun <V1, V2> `when`(
            ...
            callableV2: DeferredCallable<V2>): Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3> `when`(
            ...
            callableV3: DeferredCallable<V3>): Kromise<MultipleResults3<V1, V2, V3>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4> `when`(
            ...
            callableV4: DeferredCallable<V4>): Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4, V5> `when`(
            ...
            callableV5: DeferredCallable<V5>): Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4, V5> `when`(
            ...
            vararg callables: DeferredCallable<*>): Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    ...
    fun <V1, V2> `when`(
            ...
            taskV2: DeferredFutureTask<V2>): Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3> `when`(
            ...
            taskV3: DeferredFutureTask<V3>): Kromise<MultipleResults3<V1, V2, V3>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4> `when`(
            ...
            taskV4: DeferredFutureTask<V4>): Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4, V5> `when`(
            ...
            taskV5: DeferredFutureTask<V5>): Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4, V5> `when`(
            ...
            vararg tasks: DeferredFutureTask<*>): Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    ...
    fun <V1, V2> `when`(
            futureV1: Future<V1>,
            futureV2: Future<V2>): Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3> `when`(
            futureV1: Future<V1>,
            futureV2: Future<V2>,
            futureV3: Future<V3>): Kromise<MultipleResults3<V1, V2, V3>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4> `when`(
            ...
            futureV2: Future<V2>,
            futureV3: Future<V3>,
            futureV4: Future<V4>): Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4, V5> `when`(
            ...
            futureV3: Future<V3>,
            futureV4: Future<V4>,
            futureV5: Future<V5>): Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    ...
    fun <V1, V2, V3, V4, V5> `when`(
            ...
            futureV5: Future<V5>,
            future6: Future<*>,
            vararg futures: Future<*>): Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    ...
    fun race(
            runnableV1: Runnable,
            runnableV2: Runnable,
            vararg runnables: Runnable): Kromise<OneResult<*>, OneReject<Throwable>>
    ...
    fun race(
            callableV1: Callable<*>,
            callableV2: Callable<*>,
            vararg callables: Callable<*>): Kromise<OneResult<*>, OneReject<Throwable>>
     ...
     * @since 2.0
     */
    fun race(runnableV1: DeferredRunnable,
    ...
    fun settle(
            runnableV1: Runnable,
            runnableV2: Runnable,
            vararg runnables: Runnable): Kromise<AllValues, Throwable>
    ...
    fun settle(
            callableV1: Callable<*>,
            callableV2: Callable<*>,
            vararg callables: Callable<*>): Kromise<AllValues, Throwable>
    ...
    fun settle(
            futureV1: Future<*>,
            futureV2: Future<*>,
            vararg futures: Future<*>): Kromise<AllValues, Throwable>
     ...
     * @since 2.0
     */
    fun `when`(iterable: Iterable<*>): Kromise<MultipleResults, OneReject<*>>
     ...
     * @since 2.0
     */
    fun race(iterable: Iterable<*>): Kromise<OneResult<*>, OneReject<Throwable>>
     ...
     * @since 2.0
     */
    fun settle(iterable: Iterable<*>): Kromise<AllValues, Throwable>
     ...
     * @since 2.0
     */
    fun <D, F> resolve(resolve: D): Kromise<D, F>
     ...
     * @since 2.0
     */
    fun <D, F> reject(reject: F): Kromise<D, F>
}
