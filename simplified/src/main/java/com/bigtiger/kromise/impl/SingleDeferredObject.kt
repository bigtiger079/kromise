...
internal class SingleDeferredObject(tasks: Array<DeferredFutureTask<*>?>)
    : DeferredObject<OneResult<*>, OneReject<Throwable>>(), Kromise<OneResult<*>, OneReject<Throwable>> {
    ...
    private fun <D> configureTask(index: Int, task: DeferredFutureTask<D>) {
