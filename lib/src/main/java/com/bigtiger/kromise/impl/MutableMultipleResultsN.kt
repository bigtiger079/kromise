...
internal class MutableMultipleResultsN<V1, V2, V3, V4, V5>(size: Int) : AbstractMutableMultipleResults(size), MutableMultipleResults, MultipleResultsN<V1, V2, V3, V4, V5> {
