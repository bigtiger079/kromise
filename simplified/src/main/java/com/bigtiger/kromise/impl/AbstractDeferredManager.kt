...
abstract class AbstractDeferredManager: DeferredManager {
    ...
    override fun <F, V1, V2> `when`(kromiseV1: Kromise<V1, *>, kromiseV2: Kromise<V2, *>)
            : Kromise<MultipleResults2<V1, V2>, OneReject<F>> {

        assertNotNull(kromiseV1, PROMISE_V1)
        assertNotNull(kromiseV2, PROMISE_V2)
        return MasterDeferredObject2(kromiseV1, kromiseV2) as Kromise<MultipleResults2<V1, V2>, OneReject<F>>
    }

    override fun <F, V1, V2, V3> `when`(kromiseV1: Kromise<V1, *>, kromiseV2: Kromise<V2, *>, kromiseV3: Kromise<V3, *>)
            : Kromise<MultipleResults3<V1, V2, V3>, OneReject<F>> {

        assertNotNull(kromiseV1, PROMISE_V1)
        assertNotNull(kromiseV2, PROMISE_V2)
        assertNotNull(kromiseV3, PROMISE_V3)
        return MasterDeferredObject3(kromiseV1, kromiseV2, kromiseV3) as Kromise<MultipleResults3<V1, V2, V3>, OneReject<F>>
    }
    ...
    override fun <F, V1, V2, V3, V4> `when`(kromiseV1: Kromise<V1, *>,
            ...
            : Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<F>> {

        assertNotNull(kromiseV1, PROMISE_V1)
        assertNotNull(kromiseV2, PROMISE_V2)
        assertNotNull(kromiseV3, PROMISE_V3)
        assertNotNull(kromiseV4, PROMISE_V4)
        return MasterDeferredObject4(kromiseV1, kromiseV2, kromiseV3, kromiseV4) as Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<F>>
    }
    ...
    override fun <F, V1, V2, V3, V4, V5> `when`(kromiseV1: Kromise<V1, *>,
            ...
            : Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<F>> {
        ...
        return MasterDeferredObject5(kromiseV1, kromiseV2, kromiseV3, kromiseV4, kromiseV5) as Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<F>>
    }
    ...
    override fun <F, V1, V2, V3, V4, V5> `when`(kromiseV1: Kromise<V1, *>,
            ...
            : Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<F>> {
        ...
        return MasterDeferredObjectN(kromiseV1,
                kromiseV2,
                kromiseV3,
                kromiseV4,
                kromiseV5,
                kromise6,
                *kromiseN as Array<out Kromise<*, *>>) as Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<F>>
    }

    override fun `when`(runnable1: Runnable, runnable2: Runnable, vararg runnables: Runnable)
            : Kromise<MultipleResults, OneReject<Throwable>> {
...
//        kromises[1] = `when`(runnable2)
        ...
        when (kromises.size) {
            2 -> return `when`<Throwable, Void,  Void>(kromises[0], kromises[1]) as Kromise<MultipleResults, OneReject<Throwable>>
            3 -> return `when`<Throwable, Void,  Void, Void>(kromises[0], kromises[1], kromises[2]) as Kromise<MultipleResults, OneReject<Throwable>>
            4 -> return `when`<Throwable, Void,  Void, Void, Void>(kromises[0], kromises[1], kromises[2], kromises[3]) as Kromise<MultipleResults, OneReject<Throwable>>
            5 -> return `when`<Throwable, Void,  Void, Void, Void, Void>(kromises[0], kromises[1], kromises[2], kromises[3], kromises[4]) as Kromise<MultipleResults, OneReject<Throwable>>
            else -> {
                val kromiseN = arrayOfNulls<Kromise<*, *>>(kromises.size - 5)
                System.arraycopy(kromises, 5, kromiseN, 0, kromiseN.size)
                return MasterDeferredObjectN(kromises[0], kromises[1], kromises[2], kromises[3], kromises[4], kromises[5], *kromiseN) as Kromise<MultipleResults, OneReject<Throwable>>
            }
        }
    }

    override fun <V1, V2> `when`(callableV1: Callable<V1>, callableV2: Callable<V2>)
            : Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>> {

        assertNotNull(callableV1, CALLABLE_V1)
        assertNotNull(callableV2, CALLABLE_V2)

        return MasterDeferredObject2(`when`(callableV1), `when`(callableV2)) as Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>>
    }

    override fun <V1, V2, V3> `when`(callableV1: Callable<V1>, callableV2: Callable<V2>, callableV3: Callable<V3>)
            : Kromise<MultipleResults3<V1, V2, V3>, OneReject<Throwable>> {

        assertNotNull(callableV1, CALLABLE_V1)
        assertNotNull(callableV2, CALLABLE_V2)
        assertNotNull(callableV3, CALLABLE_V3)

        return MasterDeferredObject3(`when`(callableV1), `when`(callableV2), `when`(callableV3)) as Kromise<MultipleResults3<V1, V2, V3>, OneReject<Throwable>>
    }
    ...
    override fun <V1, V2, V3, V4> `when`(callableV1: Callable<V1>, callableV2: Callable<V2>, callableV3: Callable<V3>, callableV4: Callable<V4>)
            : Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<Throwable>> {
        assertNotNull(callableV1, CALLABLE_V1)
        assertNotNull(callableV2, CALLABLE_V2)
        assertNotNull(callableV3, CALLABLE_V3)
        assertNotNull(callableV4, CALLABLE_V4)
        return MasterDeferredObject4(`when`(callableV1), `when`(callableV2), `when`(callableV3), `when`(callableV4)) as Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<Throwable>>
    }
    ...
    override fun <V1, V2, V3, V4, V5> `when`(callableV1: Callable<V1>,
            ...
            : Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<Throwable>> {
        ...
        return MasterDeferredObject5(`when`(callableV1), `when`(callableV2), `when`(callableV3), `when`(callableV4), `when`(callableV5)) as Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    }
    ...
    override fun <V1, V2, V3, V4, V5> `when`(callableV1: Callable<V1>,
                                             ...
                                             callableV5: Callable<V5>,
                                             callable6: Callable<*>,
                                             vararg callables: Callable<*>)
            : Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<Throwable>> {
        ...
        return MasterDeferredObjectN(kromise1, kromise2, kromise3, kromise4, kromise5, `when`(callable6), *kromiseN) as Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    }


    override fun <V1, V2> `when`(callableV1: DeferredCallable<V1>,
                                 callableV2: DeferredCallable<V2>)
            : Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>> {

        assertNotNull(callableV1, CALLABLE_V1)
        assertNotNull(callableV2, CALLABLE_V2)
        return MasterDeferredObject2(`when`<V1>(callableV1), `when`<V2>(callableV2)) as Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>>
    }

    override fun <V1, V2, V3> `when`(callableV1: DeferredCallable<V1>,
                                     callableV2: DeferredCallable<V2>,
        ...
        assertNotNull(callableV2, CALLABLE_V2)
        assertNotNull(callableV3, CALLABLE_V3)
        return MasterDeferredObject3(`when`<V1>(callableV1), `when`<V2>(callableV2), `when`<V3>(callableV3)) as Kromise<MultipleResults3<V1, V2, V3>, OneReject<Throwable>>
    }

    override fun <V1, V2, V3, V4> `when`(callableV1: DeferredCallable<V1>,
                                         callableV2: DeferredCallable<V2>,
                                         callableV3: DeferredCallable<V3>,
        ...
        return MasterDeferredObject4(`when`<V1>(callableV1), `when`<V2>(callableV2), `when`<V3>(callableV3), `when`<V4>(callableV4)) as Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<Throwable>>
    }

    override fun <V1, V2, V3, V4, V5> `when`(callableV1: DeferredCallable<V1>,
                                             callableV2: DeferredCallable<V2>,
                                             callableV3: DeferredCallable<V3>,
                                             callableV4: DeferredCallable<V4>,
        ...
        assertNotNull(callableV4, CALLABLE_V4)
        assertNotNull(callableV5, CALLABLE_V5)
        return MasterDeferredObject5(`when`<V1>(callableV1), `when`<V2>(callableV2), `when`<V3>(callableV3), `when`<V4>(callableV4), `when`<V5>(callableV5)) as Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    }
    ...
    override fun <V1, V2, V3, V4, V5> `when`(callableV1: DeferredCallable<V1>,
                                             ...
                                             vararg callables: DeferredCallable<*>)
            : Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<Throwable>> {
        ...
        return MasterDeferredObjectN(kromise1, kromise2, kromise3, kromise4, kromise5, kromise6, *kromiseN) as Kromise<MultipleResultsN<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    }



    override fun <V1, V2> `when`(taskV1: DeferredFutureTask<V1>,
                                 taskV2: DeferredFutureTask<V2>)
            : Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>> {

        assertNotNull(taskV1, TASK_V1)
        assertNotNull(taskV2, TASK_V2)
        return MasterDeferredObject2(`when`<V1>(taskV1), `when`<V2>(taskV2)) as Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>>
    }

    override fun <V1, V2, V3> `when`(taskV1: DeferredFutureTask<V1>,
                                     taskV2: DeferredFutureTask<V2>,
        ...
        return MasterDeferredObject3(`when`<V1>(taskV1), `when`<V2>(taskV2), `when`<V3>(taskV3)) as Kromise<MultipleResults3<V1, V2, V3>, OneReject<Throwable>>
    }

    override fun <V1, V2, V3, V4> `when`(taskV1: DeferredFutureTask<V1>,
                                         taskV2: DeferredFutureTask<V2>,
                                         taskV3: DeferredFutureTask<V3>,
        ...
        return MasterDeferredObject4(`when`<V1>(taskV1), `when`<V2>(taskV2), `when`<V3>(taskV3), `when`<V4>(taskV4)) as Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<Throwable>>
    }
    ...
    override fun <V1, V2, V3, V4, V5> `when`(taskV1: DeferredFutureTask<V1>,
        ...
        return MasterDeferredObject5(`when`(taskV1), `when`(taskV2), `when`(taskV3), `when`(taskV4), `when`(taskV5)) as Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    }
    ...
    override fun <V1, V2> `when`(futureV1: Future<V1>,
                                 futureV2: Future<V2>)
            : Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>> {
        ...
        return MasterDeferredObject2(`when`(futureV1), `when`(futureV2)) as Kromise<MultipleResults2<V1, V2>, OneReject<Throwable>>
    }
    ...
    override fun <V1, V2, V3> `when`(futureV1: Future<V1>, futureV2: Future<V2>, futureV3: Future<V3>)
        ...
        return MasterDeferredObject3(`when`(futureV1), `when`(futureV2), `when`(futureV3)) as Kromise<MultipleResults3<V1, V2, V3>, OneReject<Throwable>>
    }
    ...
    override fun <V1, V2, V3, V4> `when`(futureV1: Future<V1>, futureV2: Future<V2>,
        ...
        return MasterDeferredObject4(`when`(futureV1), `when`(futureV2), `when`(futureV3), `when`(futureV4)) as Kromise<MultipleResults4<V1, V2, V3, V4>, OneReject<Throwable>>
    }
    ...
    override fun <V1, V2, V3, V4, V5> `when`(futureV1: Future<V1>,
        ...
        return MasterDeferredObject5(`when`(futureV1), `when`(futureV2), `when`(futureV3), `when`(futureV4), `when`(futureV5)) as Kromise<MultipleResults5<V1, V2, V3, V4, V5>, OneReject<Throwable>>
    }
    ...
    override fun <D, F> `when`(kromise: Kromise<D, F>): Kromise<D, F> {
        assertNotNull(kromise, "kromise")
        return kromise
    }

    override fun <D> `when`(callable: DeferredCallable<D>): Kromise<D, Throwable> {
        assertNotNull(callable, "callable")
        return `when`(DeferredFutureTask(callable))
    }

    override fun `when`(runnable: DeferredRunnable): Kromise<Void, Throwable> {
        return `when`(DeferredFutureTask(runnable))
    }


    override fun `when`(runnable: Runnable): Kromise<Void, Throwable> {
        assertNotNull(runnable, "runnable")
        return `when`(DeferredFutureTask(runnable))
    }

    override fun <D> `when`(callable: Callable<D>): Kromise<D, Throwable> {
        assertNotNull(callable, "callable")
        return `when`(DeferredFutureTask(callable))
    }

    override fun <D> `when`(task: DeferredFutureTask<D>): Kromise<D, Throwable> {
    ...
    override fun <D> `when`(future: Future<D>): Kromise<D, Throwable> {
        // make sure the task is automatically started
        return `when`(deferredCallableFor(future))
    }

    override fun race(runnableV1: Runnable, runnableV2: Runnable, vararg runnables: Runnable): Kromise<OneResult<*>, OneReject<Throwable>> {
        ...
        allTasks[0] = DeferredFutureTask<Void>(runnableV1)
        allTasks[1] = DeferredFutureTask<Void>(runnableV2)
        if (runnables != null) {
            for (i in runnables.indices) {
                allTasks[2 + i] = DeferredFutureTask<Void>(runnables[i])
            }
        }
    ...
    override fun race(callableV1: Callable<*>,
                      callableV2: Callable<*>,
                      vararg callables: Callable<*>)
            : Kromise<OneResult<*>, OneReject<Throwable>> {

        assertNotNull(callableV1, CALLABLE_V1)
        assertNotNull(callableV2, CALLABLE_V2)

        val allTasks = arrayOfNulls<DeferredFutureTask<*>>(2 + (callables?.size ?: 0))
        allTasks[0] = DeferredFutureTask<Any>(callableV1 as Callable<Any>)
        allTasks[1] = DeferredFutureTask<Any>(callableV2 as Callable<Any>)

        if (callables != null) {
            for (i in callables.indices) {
                allTasks[2 + i] = DeferredFutureTask<Any>(callables[i] as Callable<Any>)
            }
        }
    ...
    override fun race(runnableV1: DeferredRunnable,
                      runnableV2: DeferredRunnable,
                      vararg runnables: DeferredRunnable): Kromise<OneResult<*>, OneReject<Throwable>> {
    ...
    override fun race(callableV1: DeferredCallable<*>,
                      callableV2: DeferredCallable<*>,
                      vararg callables: DeferredCallable<*>): Kromise<OneResult<*>, OneReject<Throwable>> {

        assertNotNull(callableV1, CALLABLE_V1)
        assertNotNull(callableV2, CALLABLE_V2)

        val allTasks = arrayOfNulls<DeferredFutureTask<*>>(2 + (callables?.size ?: 0))
        allTasks[0] = DeferredFutureTask(callableV1 as DeferredCallable<Any>)
        allTasks[1] = DeferredFutureTask(callableV2 as DeferredCallable<Any>)
        if (callables != null) {
            for (i in callables.indices) {
                allTasks[2 + i] = DeferredFutureTask(callables[i] as DeferredCallable<Any>)
            }
        }
    ...
    override fun race(futureV1: Future<*>,
                      futureV2: Future<*>,
                      vararg futures: Future<*>): Kromise<OneResult<*>, OneReject<Throwable>> {
    ...
    override fun race(taskV1: DeferredFutureTask<*>,
                      taskV2: DeferredFutureTask<*>,
                      vararg tasks: DeferredFutureTask<*>): Kromise<OneResult<*>, OneReject<Throwable>> {
    ...
    protected fun submitForSingle(tasks: Array<DeferredFutureTask<*>?>): Kromise<OneResult<*>, OneReject<Throwable>> {
        for (task in tasks) {
            submit(task!!)
        }
    ...
    protected fun <D> deferredCallableFor(future: Future<D>): DeferredCallable<D> {
        assertNotNull(future, "future")

        return object : DeferredCallable<D>(StartPolicy.AUTO) {
    ...
    override fun settle(runnableV1: Runnable, runnableV2: Runnable, vararg runnables: Runnable): Kromise<AllValues, Throwable> {
        assertNotNull(runnableV1, RUNNABLE_V1)
        assertNotNull(runnableV2, RUNNABLE_V2)
    ...
    override fun settle(callableV1: Callable<*>, callableV2: Callable<*>, vararg callables: Callable<*>): Kromise<AllValues, Throwable> {
        assertNotNull(callableV1, CALLABLE_V1)
        assertNotNull(callableV2, CALLABLE_V2)
    ...
    override fun settle(runnableV1: DeferredRunnable,
                        runnableV2: DeferredRunnable,
                        vararg runnables: DeferredRunnable): Kromise<AllValues, Throwable> {
    ...
    override fun settle(callableV1: DeferredCallable<*>,
                        callableV2: DeferredCallable<*>,
                        vararg callables: DeferredCallable<*>): Kromise<AllValues, Throwable> {
    ...
    override fun settle(futureV1: Future<*>, futureV2: Future<*>, vararg futures: Future<*>): Kromise<AllValues, Throwable> {
        assertNotNull(futureV1, FUTURE_V1)
        assertNotNull(futureV2, FUTURE_V2)
    ...
    override fun settle(taskV1: DeferredFutureTask<*>,
                        taskV2: DeferredFutureTask<*>,
                        vararg tasks: DeferredFutureTask<*>): Kromise<AllValues, Throwable> {
    ...
    override fun settle(kromiseV1: Kromise<*, *>,
                        kromiseV2: Kromise<*, *>,
                        vararg kromises: Kromise<*, *>): Kromise<AllValues, Throwable> {
    ...
    override fun `when`(iterable: Iterable<*>): Kromise<MultipleResults, OneReject<*>> {
        if (iterable == null) {
    ...
    override fun race(iterable: Iterable<*>): Kromise<OneResult<*>, OneReject<Throwable>> {
        if (iterable == null) {
            throw IllegalArgumentException("Iterable is null")
        }
    ...
    override fun settle(iterable: Iterable<*>): Kromise<AllValues, Throwable> {
        if (iterable == null) {
            throw IllegalArgumentException("Iterable is null")
        }
    ...
    override fun <D, F> resolve(resolve: D): Kromise<D, F> {
        return DeferredObject<D, F>().resolve(resolve).kromise()
    }

    override fun <D, F> reject(reject: F): Kromise<D, F> {
        return DeferredObject<D, F>().reject(reject).kromise()
    }
